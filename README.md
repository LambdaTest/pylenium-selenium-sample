# Run Pylenium Selenium Tests on TestMu AI (Formerly LambdaTest)
...
With TestMu AI (Formerly LambdaTest), you can run Pylenium-based Selenium tests across real browsers and operating systems. This sample shows how to configure Pylenium to run serial and parallel browser automation tests on the TestMu AI cloud.
...
```bash
git clone https://github.com/LambdaTest/pylenium-selenium-sample && cd pylenium-selenium-sample
...
```bash
python -m pytest Serial/LT_ToDo_App/tests/test_todo_app.py
```

For parallel tests:

```bash
python -m pytest Parallel/LT_ToDo_App/tests/test_todo_app.py
```
